# 2 prompt gửi cho model (1 để viết lại câu hỏi, 1 để trả lời từ CV)


CONDENSE_PROMPT = """Cho lịch sử hội thoại và câu hỏi mới của user, viết lại câu hỏi thành câu standalone có đầy đủ context, không cần lịch sử cũng hiểu được.
...
ANSWER_PROMPT = """Bạn là trợ lý HR phân tích CV. Trả lời câu hỏi DỰA HOÀN TOÀN vào nội dung CV bên dưới.
